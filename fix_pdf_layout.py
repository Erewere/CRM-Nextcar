...
old_pdf_layout = """        {/* Hidden PDF View */}
        <div className="fixed top-[-9999px] left-[-9999px] pointer-events-none">
          <div ref={pdfRef} className="w-[800px] h-[1131px] flex flex-col items-center justify-between p-8 font-sans relative" style={{ background: 'linear-gradient(to bottom right, #0f172a, #1e293b)', color: '#ffffff' }}>
            ...
            {/* Large Vehicle Image */}
            <div className="w-[700px] h-[380px] rounded-[30px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border-[8px] relative flex items-center justify-center mb-4 z-10" style={{ borderColor: 'rgba(255,255,255,0.1)', backgroundColor: '#1e293b' }}>
...
content = content.replace(old_pdf_layout, new_pdf_layout)
