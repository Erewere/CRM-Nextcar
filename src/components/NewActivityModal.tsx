...
function TimeSelect({ value, onChange, placeholder }: { value: string, onChange: (v: string) => void, placeholder: string }) {
  ...
  return (
    <div className="relative" ref={containerRef}>
      <div 
        className={clsx(
          "flex items-center justify-between border rounded p-1.5 text-sm w-[110px] bg-white cursor-pointer transition-colors",
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-1 w-[120px] max-h-60 overflow-y-auto bg-white border border-gray-200 rounded shadow-lg z-50 py-1">
            ...
            return (
              <div
                ...
                className={clsx(
                  ...
                  isActive ? "bg-blue-600 text-white active-time-option" : "text-gray-700 hover:bg-blue-50 hover:text-blue-600"
                )}
                onClick={() => {
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex justify-center items-center p-4">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-5xl h-[85vh] flex flex-col overflow-hidden">
        ...
        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-800">Schedule an activity</h2>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-2/3 overflow-y-auto p-6 flex flex-col gap-6">
                ...
                {types.map(t => {
                  ...
                  return (
                    <button
                      ...
                      className={clsx(
                        "p-2 border-r border-gray-300 last:border-r-0 hover:bg-gray-50 transition-colors",
                        type === t.id ? "bg-blue-50 text-blue-600" : "text-gray-600"
                      )}
                      title={t.label}
                    >
            ...
            {/* Free/Busy */}
            <div className="flex items-center gap-4">
              <CalendarX className="w-5 h-5 text-gray-500 flex-shrink-0" />
            ...
            <div className="flex gap-4">
              <FileText className="w-5 h-5 text-gray-500 flex-shrink-0 mt-2" />
              <div className="flex-1">
                <textarea 
                  value={notes}
                  onChange={e => setNotes(e.target.value)}
                  className="w-full border border-gray-300 rounded bg-[#fff9db] p-3 min-h-[100px] outline-none focus:ring-2 focus:ring-blue-500"
                ></textarea>
                <p className="text-xs text-gray-500 mt-1">Las notas son visibles dentro de Pipedrive, pero no para los invitados al evento</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <LinkIcon className="w-5 h-5 text-gray-500 flex-shrink-0 mt-2" />
              <div className="flex-1 flex flex-col gap-2">
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full border border-gray-300 rounded py-2 pl-9 pr-3 text-sm focus:ring-2 focus:ring-blue-500 outline-none" 
                  />
                ...
                <div className="relative">
                  ...
                  <select 
                    ...
                    className="w-full border border-gray-300 rounded py-2 pl-9 pr-3 text-sm focus:ring-2 focus:ring-blue-500 outline-none appearance-none"
                  >
          ...
          <div className="w-1/3 bg-white border-l border-gray-200 flex flex-col">
            <div className="px-4 py-3 border-b border-gray-200 flex justify-between items-center bg-white shadow-sm z-10">
              <span className="font-bold text-gray-800 text-sm">
                {format(previewDate, "EEEE, MMMM do", { locale: es })}
              </span>
              <div className="flex">
                <button onClick={() => setPreviewDate(subDays(previewDate, 1))} className="p-1 hover:bg-gray-100 rounded text-gray-500"><ChevronLeft className="w-4 h-4" /></button>
                <button onClick={() => setPreviewDate(addDays(previewDate, 1))} className="p-1 hover:bg-gray-100 rounded text-gray-500"><ChevronRight className="w-4 h-4" /></button>
              </div>
            </div>
            <div className="flex-1 overflow-y-auto relative">
              ...
              {hours.map((hour, i) => (
                <div key={hour} className="flex h-[60px] border-b border-gray-100 last:border-b-0 group">
              ...
              <div className="absolute top-[280px] left-0 right-0 border-t border-red-500 z-20 flex items-center">
                <div className="text-[10px] text-red-500 w-12 text-right pr-1 bg-white font-bold tracking-tighter -mt-2">23:05</div>
        ...
        <div className="px-6 py-4 border-t border-gray-200 flex justify-between items-center bg-gray-50">
          <div className="flex items-center gap-4">
            <button className="p-2 border border-gray-300 rounded hover:bg-gray-100 text-gray-600">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={onClose} className="px-6 py-2 border border-gray-300 rounded font-bold text-gray-700 hover:bg-gray-100 text-sm">
              Cancelar
            </button>
            <button 
              onClick={() => {
