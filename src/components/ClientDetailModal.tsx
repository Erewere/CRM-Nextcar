          ...
          {showPaymentDrawer && (formData.saleDetails || formData.status === 'won') && (() => {
            ...
            return (
              <>
                ...
                >
                  {/* DRAWER HEADER */}
                  <div className="p-4 bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 text-white flex items-center justify-between gap-2 shadow-md shrink-0">
                    <div className="flex items-center gap-2.5 min-w-0">
                      <div className="p-2 rounded-xl bg-white/20 backdrop-blur-md">
                        <Calculator className="w-5 h-5 text-white" />
                      </div>
                      <div>
                        <h3 className="text-sm font-bold flex items-center gap-2 leading-tight">
                          <span className="truncate">Detalles de Venta &amp; Pagos</span>
                          {remaining === 0 && actualPrice > 0 ? (
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      {puedeEliminarTratos && (
                        <button
                          ...
                          className="text-[11px] px-2 py-1 bg-white/15 text-white hover:bg-white/25 font-semibold rounded-md transition-all flex items-center gap-1 shrink-0 border border-white/30 whitespace-nowrap"
                      ...
                      {canRegisterPayments && (
                        <button
                          ...
                          className="text-[11px] px-2 py-1 bg-white text-emerald-800 hover:bg-emerald-50 active:scale-95 font-bold rounded-md shadow transition-all flex items-center gap-1 shrink-0 whitespace-nowrap"
                        >
